...
public class VueEtatConvoyage5 extends javax.swing.JFrame {

    public VueEtatConvoyage5() {
        initComponents();
        doMyInit();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ETAT DE CONVOYAGE 5");
        ...
        jPanelJurys.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Gérer l'effectif", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 3, 14), new java.awt.Color(0, 0, 255))); // NOI18N
            ...
            .addGroup(jPanelJurysLayout.createSequentialGroup()
                .addGroup(jPanelJurysLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelJurysLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldEffectif, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButtonVisualiserEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVisualiserEtatsActionPerformed
        infoSaisies();
        Map<Centre, Integer> centreEffectifMap = new HashMap<>();//contient l'ensemble des centres avec leur effectif
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            Rubriquetat rubetat = metier.findRubriquetatByDesignation("INDEMNITE POUR CONVOYAGE 5 ET VENTILATION DES COPIES");
            ...
            if (!poursuivre) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de convoyage 5 n'ont pas encore été créés pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                ...
                //remplissage centreEffectifMap
                tousNbnotesprat2 = metier.findAllNbnotesprat2D1GroupedexamensD1Session(anneeSelected, niveauSelected, typeSelected);
                if (!tousNbnotesprat2.isEmpty()) {
                    for (Nbnotesprat2 nbnotesprat2 : tousNbnotesprat2) {
                        centreEffectifMap.put(nbnotesprat2.getCentre(), nbnotesprat2.getNombre());
                    }
                }
                ...
                try {
                        ...
                        for (Centrebilletage centrebilletage : centrebilletageSouscentresMap.keySet()) {
                            ...
                            if (region.getNomreg().equals(centrebilletage.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg())) {
                                ...
                                for (int i = 0; i < souscentresList.size(); i++) {
                                    ...
                                    if (centreEffectifMap.containsKey(sonCentre)) {
                                        determinerCout(centreEffectifMap, sonCentre);
                                        ...
                                        row.put("cm", "Chargé de Mission pratique 2");
                    ...
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatConvoyage5Report.jrxml");
    ...
    private void jButtonCreerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEtatsActionPerformed
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
            if (!caisses.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de convoyage 5 existent déjà pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                examensList = groupedexamensEnstring.split(separateur);
                for (int i = 0; i < examensList.length; i++) {
                ...
                try {
                    for (Centre centre : centreEffectifMap.keySet()) {
                        determinerCout(centreEffectifMap, centre);
                ...
                if (testsicreer) {
                    JOptionPane.showMessageDialog(this, "Etats de convoyage 5 créés avec succès pour ce groupe d'examens !");
                }
            }
        } else {
    ...
    private void jButtonMettreAjourEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMettreAjourEtatsActionPerformed
        infoSaisies();
        Map<Centre, Integer> centreEffectifMap = new HashMap<>();//contient l'ensemble des centres avec leur effectif
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment modifier les états de convoyage 5 pour ce groupe d'examens ?", "confirmation de modification", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                ...
                caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
                if (caisses.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Erreur, aucun état de convoyage 5 n'existe pour ce groupe d'examens !");
                } else {
    ...
    private void jButtonSupprimerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEtatsActionPerformed
        infoSaisies();
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment supprimer les états de convoyage 5 pour ce groupe d'examens ?", "confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                anneeSelected = Integer.parseInt(anneeString);
                Rubriquetat rubetat = metier.findRubriquetatByDesignation("INDEMNITE POUR CONVOYAGE 5 ET VENTILATION DES COPIES");
                ...
                if (caisses.isEmpty()) {
                    ...
                    if (testsisupprimer) {
                        JOptionPane.showMessageDialog(this, "Etats de convoyage 5 supprimés avec succès pour ce groupe d'examens !");
                    }
                }
            }
        }
    ...
    private void jButtonCreerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEffectifActionPerformed
        infoSaisies();
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomCentredeliberationSelected.equals("---") || effectifString.equals("")) {
            JOptionPane.showMessageDialog(this, "Recommencez svp. Vous devez choisir un groupe d'examens, une session, un centre de délibétaion et donner l'effectif !");
        } else {
            ...
            if (!continuer || effectif == 0) {
                ...
                try {
                    metier.creerNbnotesprat2(new Nbnotesprat2(centredeliberationSelected, groupe, sessionSelected, effectif));
                    JOptionPane.showMessageDialog(this, "Effectif enregistré avec succès !");
                } catch (ObcbudgetException ex) {
                    JOptionPane.showMessageDialog(this, "Impossible de d'enregistrer l'effectif dans le centre de délibération [" + nomCentredeliberationSelected + "]" + "\n raison:" + ex.getMessage());
                }
            }
        }
    ...
    private void jButtonSupprimerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEffectifActionPerformed
        ...
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomCentredeliberationSelected.equals("---")) {
            ...
            int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment supprimer l'effectif du centre de délibération [" + nomCentredeliberationSelected + "] ?", "confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (result == JOptionPane.YES_OPTION) {
                anneeSelected = Integer.parseInt(anneeString);
                try {
                    Nbnotesprat2 nbnotesprat2 = metier.findNbnotesprat2D1CentredeliberationD1GroupedexamensD1Session(nomCentredeliberationSelected, anneeSelected, niveauSelected, typeSelected);
                    metier.supprimerNbnotesprat2(nbnotesprat2);
                    JOptionPane.showMessageDialog(this, "Effectif supprimé avec succès !");
                } catch (ObcbudgetException ex) {
                    JOptionPane.showMessageDialog(this, "Impossible de supprimer l'effectif du centre de délibération [" + nomCentredeliberationSelected + "] \n raison:" + ex.getMessage());
                }
            }
        }
    ...
    private void jButtonListerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListerEffectifActionPerformed
        infoSaisies();
        Map<Centre, Integer> centreEffectifMap = new HashMap<>();//contient chaque centre avec l'effectif correspondant
        if (groupedexamensEnstring.equals("") || anneeString.equals("---")) {
            ...
            if (!tousNbnotesprat2.isEmpty()) {
                    ...
                    for (Region region : regions) {
                        ...
                        for (Centre centre : centreEffectifMap.keySet()) {
                            if (centre.getArrondissement().getDepartement().getRegion().getNomreg().equals(region.getNomreg())) {
                                ...
                                row.put("effectif", centreEffectifMap.get(centre));
                                datasource.add(row);
                            }
                        }
                    }
                    JRDataSource jRDataSource = new JRBeanCollectionDataSource(datasource);
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatListeEffectif3Report.jrxml");//on appelle le même état qu'au convoyage 3
                    JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, jRDataSource);
                    JasperViewer jasperViewer = new JasperViewer(jasperPrint, false);//false empêche jasperviewer de fermer l'appli lorsqu'on le ferme
                    jasperViewer.setVisible(true);
                } catch (JRException e) {
                ...
                JOptionPane.showMessageDialog(this, "Aucun effectif trouvé dans la base de données !");
            }
        }
        centreEffectifMap.clear();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueEtatConvoyage5.class
    ...
    private List<Nbnotesprat2> tousNbnotesprat2 = null;
    ...
    private void doMyInit() {
        ...
        typesCombo = new String[]{"---", "IND", "IND PROF"};
    ...
    // ESG NON CONCERNE
    //acheminement des livrets scolaires des centres de délibération vers les centres de ventilation ou de regroupement par les CM
    private void determinerCout(Map<Centre, Integer> centreEffectifMap, Centre centre) {
        effectif = 0;
        tauxcolis = 500;
        effectif = centreEffectifMap.get(centre);
        ...
        tabColis[0] = 0;
        tabColis[1] = (int) Math.ceil((double) effectif / (double) 100);;
        tabColis[2] = (int) Math.ceil((double) effectif / (double) 100);
        ...
        if (distance > 0) {
            fraisconvCM = tauxcolis * nbcolis + distance*50;
        }
