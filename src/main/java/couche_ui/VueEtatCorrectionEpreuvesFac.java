...
public class VueEtatCorrectionEpreuvesFac extends javax.swing.JFrame {

    public VueEtatCorrectionEpreuvesFac() {
        initComponents();
        doMyInit();
    }
    ...
    private void initComponents() {
        ...
        jLabelNbcand = new javax.swing.JLabel();
        jTextFieldNbcand = new javax.swing.JTextField();
        ...
        jPanelEffectif.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Gérer les effectifs par épreuve facultative", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 3, 14), new java.awt.Color(0, 0, 255))); // NOI18N

        jLabelNbcand.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabelNbcand.setText("Nombre de candidats :");

        jTextFieldNbcand.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
            ...
            .addGroup(jPanelEffectifLayout.createSequentialGroup()
                .addGroup(jPanelEffectifLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelEffectifLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jComboBoxEpreuve, javax.swing.GroupLayout.PREFERRED_SIZE, 339, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(33, 33, 33)
                        .addComponent(jLabelNbcand)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldNbcand, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanelEffectifLayout.createSequentialGroup()
                        .addGap(141, 141, 141)
        ...
        jPanelEffectifLayout.setVerticalGroup(
            ...
            .addGroup(jPanelEffectifLayout.createSequentialGroup()
                ...
                .addGroup(jPanelEffectifLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelNbcand, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldNbcand, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel1.setText("ETAT DE CORRECTION");
    ...
    private void jButtonVisualiserEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVisualiserEtatsActionPerformed
        infoSaisies();
        Map<Souscentre, ArrayList<Nbcandepreuvefac>> souscentreNbcandepreuvefacMap = new HashMap<>();//contient les sous-centres chacun avec le tableau de ses Nbcandepreuvefac
        ArrayList<Souscentre> souscentresAyantDesNbcandepreuvefacList = new ArrayList<>();//liste des sous-centres ayant enregistré des candidats aux épreuves facultatives
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            Rubriquetat rubetat = metier.findRubriquetatByDesignation("CORRECTION DES EPREUVES FACULTATIVES");
            ...
            if (!poursuivre) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de correction des épreuves facultatives n'ont pas encore été créés pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                ...
                nbcandepreuvefacs = metier.findAllNbcandepreuvefacsD1GroupedexamensD1Session(anneeSelected, niveauSelected, typeSelected);

                if (!nbcandepreuvefacs.isEmpty()) {
                    //remplissage de souscentresAyantDesNbcandepreuvefacList
                    for (Nbcandepreuvefac nbcandepreuvefac : nbcandepreuvefacs) {
                        if (!souscentresAyantDesNbcandepreuvefacList.contains(nbcandepreuvefac.getSouscentre())) {
                            souscentresAyantDesNbcandepreuvefacList.add(nbcandepreuvefac.getSouscentre());
                        }
                    }
                    //remplissage de souscentreNbcandepreuvefacMap
                    for (Souscentre souscentre : souscentresAyantDesNbcandepreuvefacList) {
                        ArrayList<Nbcandepreuvefac> nbcandepreuvefacList = new ArrayList<>();
                        for (Nbcandepreuvefac nbcandepreuvefac : nbcandepreuvefacs) {
                            if (nbcandepreuvefac.getSouscentre().getNomsouscent().equals(souscentre.getNomsouscent())) {
                                nbcandepreuvefacList.add(nbcandepreuvefac);
                            }
                        }
                        souscentreNbcandepreuvefacMap.put(souscentre, nbcandepreuvefacList);
                    }
                }
                ...
                try {
                        ...
                        for (Centrebilletage centrebilletage : centrebilletageSouscentresMap.keySet()) {
                            ...
                            if (region.getNomreg().equals(centrebilletage.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg())) {
                                ...
                                for (int i = 0; i < souscentresList.size(); i++) {
                                    ...
                                    int num = 1;
                                    if (souscentreNbcandepreuvefacMap.containsKey(souscentre)) {
                                        for (Nbcandepreuvefac nbcandepreuvefac : souscentreNbcandepreuvefacMap.get(souscentre)) {
                                            determinerCout(nbcandepreuvefac);
                                            ...
                                            row.put("epreuvefac", nbcandepreuvefac.getNomepreuve());
                                            ...
                                            int totalArrondi = (int) Math.ceil((double) coutcopies / (double) 1000) * 1000;
                    ...
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatCorrectionEpreuvesFacReport.jrxml");
                ...
                souscentreNbcandepreuvefacMap.clear();
            }
        } else {
    ...
    private void jButtonCreerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEtatsActionPerformed
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
            if (!caisses.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de correction des épreuves facultatives existent déjà pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                examensList = groupedexamensEnstring.split(separateur);
                for (int i = 0; i < examensList.length; i++) {
                ...
                try {
                    for (Souscentre souscentre : souscentreNbcandepreuvefacMap.keySet()) {
                        int net = 0;
                        int totalArrondi = 0;
                        for (Nbcandepreuvefac nbcandepreuvefac : souscentreNbcandepreuvefacMap.get(souscentre)) {
                            determinerCout(nbcandepreuvefac);
                            totalArrondi = (int) Math.ceil((double) coutcopies / (double) 1000) * 1000;
                            net += totalArrondi;
                        }
                ...
                if (testsicreer) {
                    JOptionPane.showMessageDialog(this, "Etats de correction des épreuves facultatives créés avec succès pour ce groupe d'examens !");
                }
            }
        } else {
    ...
    private void jButtonMettreAjourEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMettreAjourEtatsActionPerformed
        ...
        Map<Souscentre, ArrayList<Nbcandepreuvefac>> souscentreNbcandepreuvefacMap = new HashMap<>();//contient les sous-centres chacun avec le tableau de ses Nbcandepreuvefac
        ArrayList<Souscentre> souscentresAyantDesNbcandepreuvefacList = new ArrayList<>();//liste des sous-centres ayant enregistré des candidats aux épreuves facultatives
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment modifier les états de correction des épreuves facultatives pour ce groupe d'examens ?", "confirmation de modification", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                ...
                caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
                if (caisses.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Erreur, aucun état de correction des épreuves facultatives n'existe pour ce groupe d'examens !");
                } else {
                    ...
                    if (testsimodifier) {
                        JOptionPane.showMessageDialog(this, "Etats de correction des épreuves facultatives mis à jour avec succès pour ce groupe d'examens !");
                    }
                }
            } else {
    ...
    private void jButtonSupprimerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEtatsActionPerformed
        infoSaisies();
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment supprimer les états de correction des épreuves facultatives pour ce groupe d'examens ?", "confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                anneeSelected = Integer.parseInt(anneeString);
                Rubriquetat rubetat = metier.findRubriquetatByDesignation("CORRECTION DES EPREUVES FACULTATIVES");
                ...
                if (caisses.isEmpty()) {
                    ...
                    if (testsisupprimer) {
                        JOptionPane.showMessageDialog(this, "Etats de correction des épreuves facultatives supprimés avec succès pour ce groupe d'examens !");
                    }
                }
            }
        }
    ...
    private void jButtonCreerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEffectifActionPerformed
        infoSaisies();
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomSouscentreSelected.equals("---") || nomEpreuvefacSelected.equals("---") || nbcandString.equals("")) {
            JOptionPane.showMessageDialog(this, "Recommencez svp. Vous devez choisir un groupe d'examens, une session, un sous-centre, une épreuve et donner l'effectif !");
        } else {
            validerNbcand(nbcandString);
            if (!continuerNbcand || nbcandSaisi == 0) {
                ...
                try {
                    metier.creerNbcandepreuvefac(new Nbcandepreuvefac(nomEpreuvefacSelected, nbcandSaisi, groupe, sessionSelected, souscentreSelected));
                    JOptionPane.showMessageDialog(this, "Effectif enregistré avec succès !");
                } catch (ObcbudgetException ex) {
                    JOptionPane.showMessageDialog(this, "Impossible de d'enregistrer cet effectif dans le sous-centre [" + nomSouscentreSelected + "]" + "\n raison:" + ex.getMessage());
                }
            }
        }
    ...
    private void jButtonSupprimerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEffectifActionPerformed
        infoSaisies();
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomSouscentreSelected.equals("---") || nomEpreuvefacSelected.equals("---")) {
            ...
            int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment supprimer l'effectif de l'épreueve facultative " + nomEpreuvefacSelected + " du sous-centre [" + nomSouscentreSelected + "] ?", "confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (result == JOptionPane.YES_OPTION) {
                anneeSelected = Integer.parseInt(anneeString);
                try {
                    Nbcandepreuvefac nbcandepreuvefac = metier.findNbcandepreuvefacD1EpreuvefacD1SouscentreD1GroupedexamensD1Session(nomSouscentreSelected, anneeSelected, niveauSelected, typeSelected, nomEpreuvefacSelected);
                    metier.supprimerNbcandepreuvefac(nbcandepreuvefac);
                    JOptionPane.showMessageDialog(this, "Effectif supprimé avec succès !");
                } catch (ObcbudgetException ex) {
                    JOptionPane.showMessageDialog(this, "Impossible de supprimer l'effectif de l'épreuve facultative " + nomEpreuvefacSelected + " du sous-centre [" + nomSouscentreSelected + "] \n raison:" + ex.getMessage());
                }
            }
        }
            ...
            if (!nbcandepreuvefacs.isEmpty()) {
                try {
                    ...
                    for (Region region : regions) {
                        int i = 1;
                        for (Nbcandepreuvefac nbcandepreuvefac : nbcandepreuvefacs) {
                            if (nbcandepreuvefac.getSouscentre().getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg().equals(region.getNomreg())) {
                                Map<String, Object> row = new HashMap<>();
                                row.put("session", anneeSelected);
                                row.put("examen", groupedexamensEnstring);
                                row.put("region", region.getNomreg());
                                row.put("num", i++);
                                row.put("souscentre", nbcandepreuvefac.getSouscentre().getNomsouscent());
                                row.put("epreuvefac", nbcandepreuvefac.getNomepreuve());
                                row.put("effectif", nbcandepreuvefac.getNbre());
                                datasource.add(row);
                            }
                        }
                    }
                    JRDataSource jRDataSource = new JRBeanCollectionDataSource(datasource);
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatListeNbcandepreuvefacReport.jrxml");
                    JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, jRDataSource);
                    JasperViewer jasperViewer = new JasperViewer(jasperPrint, false);//false empêche jasperviewer de fermer l'appli lorsqu'on le ferme
                    jasperViewer.setVisible(true);
                } catch (JRException e) {
                ...
                JOptionPane.showMessageDialog(this, "Aucun effectif de candidats trouvé dans la base de données !");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueEtatCorrectionEpreuvesFac.class
    ...
    private javax.swing.JLabel jLabelNbcand;
    ...
    private javax.swing.JTextField jTextFieldNbcand;
    ...
    private String nomEpreuvefacSelected = "";
    ...
    private int total = 0, effectif = 0, txcopie = 100, coutcopies = 0, nbcopies = 0;
    private boolean continuerNbcand = false;
    private int nbcandSaisi = 0;
    private String nbcandString = "";
    private List<Nbcandepreuvefac> nbcandepreuvefacs = null;
    ...
    private void infoSaisies() {
        ...
        nomEpreuvefacSelected = (String) jComboBoxEpreuve.getSelectedItem();
        nbcandString = jTextFieldNbcand.getText();
    }
    ...
    private void validerNbcand(String nbreString) {
        try {
            nbcandSaisi = Integer.parseInt(nbreString);
            continuerNbcand = true;
            ...
            continuerNbcand = false;
        }
    }

    private void determinerCout(Nbcandepreuvefac nbcandepreuvefac) {
        effectif = nbcandepreuvefac.getNbre();
        nbcopies = effectif;
        /*
        txcopie = 150; 
        if(niveauSelected.equals("BACC")) txcopie=200;
        if(!nbcandepreuvefac.getNomepreuve().equals("TM") && !nbcandepreuvefac.getNomepreuve().equals("LANGUES NATIONALES") && !nbcandepreuvefac.getNomepreuve().equals("CULTURES NATIONALES") && !nbcandepreuvefac.getNomepreuve().equals("MANUAL LABOR/HANDICRAFT")) txcopie=100;
        */
