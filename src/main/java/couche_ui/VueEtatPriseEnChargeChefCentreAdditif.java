...
public class VueEtatPriseEnChargeChefCentreAdditif extends javax.swing.JFrame {

    public VueEtatPriseEnChargeChefCentreAdditif() {
        initComponents();
        doMyInit();
    }
                ...
                if (!continuer) {
                    ...
                    if (!chefcentres.isEmpty()) {//tant qu'il n'y a pas de chef de centre/sous-centre, il ne devrait pas avoir d'assistant
                        ...
                        try {
                                            ...
                                            if (souscentreAvecChefList.contains(souscentre)) {
                                                ...
                                                for (int j = 0; j < nbtours; j++) {
                                                    if (j == 0) {//traitement du chef
                                                        ...
                                                        determinerCoutChefESG(souscentre, sonFmissprimchefcentre, souscentrePhasesProbMap, souscentrePhasesBacMap);
                            ...
                            JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatPriseEnChargeChefCentreESGAdditifReport.jrxml");
                                            ...
                                            if (souscentreAvecChefList.contains(souscentre)) {
                                                ...
                                                for (int j = 0; j < nbtours; j++) {
                                                    if (j == 0) {//traitement du chef
                                                        ...
                                                        determinerCoutChefESTP(souscentre, sonFmissprimchefcentre, souscentrePhasesProbIndMap, souscentrePhasesBacIndMap, souscentrePhasesProbComMap, souscentrePhasesBacComMap);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueEtatPriseEnChargeChefCentreAdditif.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VueEtatPriseEnChargeChefCentreAdditif().setVisible(true);
            }
        });
    }
    ...
    private void determinerCoutChefESG(Souscentre souscentre, Fmissprimchefcentre fmissprimchefcentre, Map<Souscentre, ArrayList<Character>> souscentrePhasesProbMap, Map<Souscentre, ArrayList<Character>> souscentrePhasesBacMap) {
        ...
        //calcul des frais de mission à la DRES/DDES
        misdres = 0;
        nbjoursdres = 0;
        if (fmissprimchefcentre.getLiaisondres()) {
            ...
            if (nbexams == 2) {
                ...
                if ((phasesProbList.size() == 1 && phasesBacList.size() == 3) || (phasesProbList.size() == 3 && phasesBacList.size() == 1) || (phasesProbList.size() == 3 && phasesBacList.size() == 2) || (phasesProbList.size() == 2 && phasesBacList.size() == 3)) {
                    nbjoursdres = 3;
                }
            }
            if (testSouscentreEnclave(souscentre)) {
                nbjoursdres += 1;
            }
            misdres = nbjoursdres * txjour;
        }

        //calcul des frais de mission au centre de billetage
        miscentrebil = 0;
        nbjourscentrebil = 0;
        if (fmissprimchefcentre.getLiaisoncentrebil()) {
            ...
            if ((phasesProbList.isEmpty() && phasesBacList.size() == 3) || (phasesProbList.size() == 3 && phasesBacList.isEmpty()) || (phasesProbList.size() == 3 && phasesBacList.size() == 1) || (phasesProbList.size() == 1 && phasesBacList.size() == 3) || (phasesProbList.size() == 2 && phasesBacList.size() == 3) || (phasesProbList.size() == 3 && phasesBacList.size() == 2)) {
                nbjourscentrebil = 2;
            }
        ...
        if(souscentre.getNomsouscent().equals("LYCÉE DE DZIGUILAO") || souscentre.getNomsouscent().equals("LYCÉE DE TOULOUM") || souscentre.getNomsouscent().equals("LYCÉE DE BAMENDOU") || souscentre.getNomsouscent().equals("LYCÉE DE ZENMEH")){
            indemastreChefESG=50000;
        }
        
        if(souscentre.getNomsouscent().equals("LYCÉE BILINGUE DE KOUOPTAMO")){
            misdres=150000;
        }
        if(souscentre.getNomsouscent().equals("LYCÉE DE LOUM")){
            misdres=175000;
        }
    ...
    private void determinerCoutAssistantESG(Souscentre souscentre, Fmissprimchefcentre fmissprimchefcentre, Map<Souscentre, ArrayList<Character>> souscentrePhasesProbMap, Map<Souscentre, ArrayList<Character>> souscentrePhasesBacMap) {
        ...
        if (nbexams >= 3) {
            indemforfaitAssistantESG = 150000;
            indemastreAssistantESG = 100000;
        }
        //cas frais transport       
        if (!fmissprimchefcentre.getFraistrans()) {
    ...
    private boolean testSouscentreEnclave(Souscentre souscentre) {
        boolean result = false;
        souscentresEnclaves = metier.findAllSouscentresEnclaves();
        if (souscentresEnclaves.contains(souscentre)) {
            return result;
        }
        return result;
    }
