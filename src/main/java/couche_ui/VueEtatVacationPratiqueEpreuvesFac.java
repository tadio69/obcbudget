...
public class VueEtatVacationPratiqueEpreuvesFac extends javax.swing.JFrame {

    public VueEtatVacationPratiqueEpreuvesFac() {
        initComponents();
        doMyInit();
    }
    ...
    private void initComponents() {
        ...
        jTextFieldNbexamin = new javax.swing.JTextField();
        ...
        jPanelEffectif.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Gérer les paramètres de calcul (NB: Nombre de vacations par intervenant)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 3, 14), new java.awt.Color(0, 0, 255))); // NOI18N

        jLabelNbexamin.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabelNbexamin.setText("Nombre d'examinateurs :");

        jTextFieldNbexamin.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
            ...
            .addGroup(jPanelEffectifLayout.createSequentialGroup()
                .addGroup(jPanelEffectifLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelEffectifLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldNbexamin, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(39, 39, 39)
                        .addComponent(jLabelNbvacation)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldNbvacation, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanelEffectifLayout.createSequentialGroup()
                        .addGap(235, 235, 235)
            ...
            .addGroup(jPanelEffectifLayout.createSequentialGroup()
                ...
                .addGroup(jPanelEffectifLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelEffectifLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jTextFieldNbexamin, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel1.setText("ETAT DE VACATIONS DE PRATIQUE");
    ...
    private void jButtonVisualiserEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVisualiserEtatsActionPerformed
        infoSaisies();
        Map<Souscentre, ArrayList<Eltvacpratepreuvefac>> souscentreEltvacpratepreuvefacMap = new HashMap<>();//contient les sous-centres chacun avec le tableau de ses Eltvacpratepreuvefac
        ...
        ArrayList<Souscentre> souscentresAyantDesVacEpreuvefacList = new ArrayList<>();//liste des sous-centres ayant enregistré des candidats aux épreuves facultatives
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            Rubriquetat rubetat = metier.findRubriquetatByDesignation("VACATION PRATIQUE D'EPREUVES FACULTATIVES");
            ...
            if (!poursuivre) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de vacation pratique d'épreuves facultatives n'ont pas encore été créés pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                ...
                eltvacpratepreuvefacs = metier.findAllEltvacpratepreuvefacsD1GroupedexamensD1Session(anneeSelected, niveauSelected, typeSelected);

                if (!eltvacpratepreuvefacs.isEmpty()) {
                    //remplissage de souscentresAyantDesVacEpreuvefacList
                    for (Eltvacpratepreuvefac eltvacpratepreuvefac : eltvacpratepreuvefacs) {
                        if (!souscentresAyantDesVacEpreuvefacList.contains(eltvacpratepreuvefac.getSouscentre())) {
                            souscentresAyantDesVacEpreuvefacList.add(eltvacpratepreuvefac.getSouscentre());
                        }
                    }
                    //remplissage de souscentreEltvacpratepreuvefacMap
                    for (Souscentre souscentre : souscentresAyantDesVacEpreuvefacList) {
                        ArrayList<Eltvacpratepreuvefac> eltvacpratepreuvefacList = new ArrayList<>();
                        for (Eltvacpratepreuvefac eltvacpratepreuvefac : eltvacpratepreuvefacs) {
                            if (eltvacpratepreuvefac.getSouscentre().getNomsouscent().equals(souscentre.getNomsouscent())) {
                                eltvacpratepreuvefacList.add(eltvacpratepreuvefac);
                            }
                        }
                        souscentreEltvacpratepreuvefacMap.put(souscentre, eltvacpratepreuvefacList);
                    }
                }
                ...
                if (!eltetatmoepreuvefacs.isEmpty()) {
                    ...
                    for (Souscentre souscentre : souscentresAyantDesVacEpreuvefacList) {//on ne considère ceux des sous_centres qui ont des vacations pas tous ceux enregistrés pour la MO
                ...
                try {
                        ...
                        for (Centrebilletage centrebilletage : centrebilletageSouscentresMap.keySet()) {
                            ...
                            if (region.getNomreg().equals(centrebilletage.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg())) {
                                ...
                                for (int i = 0; i < souscentresList.size(); i++) {
                                    ...
                                    int num = 1;
                                    if (souscentreEltvacpratepreuvefacMap.containsKey(souscentre)) {
                                        for (Eltvacpratepreuvefac eltvacpratepreuvefac : souscentreEltvacpratepreuvefacMap.get(souscentre)) {
                                            Eltetatmoepreuvefac sonEltetatmoepreuvefac = new Eltetatmoepreuvefac();
                                            for (Eltetatmoepreuvefac eltetatmoepreuvefac : souscentreEltetatmoepreuvefacMap.get(souscentre)) {
                                                if (eltetatmoepreuvefac.getEpreuve().getSigle().equals(eltvacpratepreuvefac.getEpreuve().getSigle())) {
                                                    sonEltetatmoepreuvefac = eltetatmoepreuvefac;
                                                    break;
                                                }
                                            }
                                            determinerCoutD1eltvacpratepreuvefac(eltvacpratepreuvefac,sonEltetatmoepreuvefac);
                                            ...
                                            row.put("epreuvefac", eltvacpratepreuvefac.getEpreuve().getSigle());
                                            row.put("effectif", effectif);
                                            row.put("nbexamin", nbexamin);
                                            row.put("nbvac", nbvac);
                                            row.put("nbtotalvac", nbtotalvac);
                    ...
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatVacationEpreuvesFacReport.jrxml");
    ...
    private void jButtonCreerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEtatsActionPerformed
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
            if (!caisses.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de vacation pratique d'épreuves facultatives existent déjà pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                examensList = groupedexamensEnstring.split(separateur);
                for (int i = 0; i < examensList.length; i++) {
                ...
                try {
                    for (Souscentre souscentre : souscentreEltvacpratepreuvefacMap.keySet()) {
                        int net = 0;
                        int totalArrondi = 0;
                        for (Eltvacpratepreuvefac eltvacpratepreuvefac : souscentreEltvacpratepreuvefacMap.get(souscentre)) {
                            Eltetatmoepreuvefac sonEltetatmoepreuvefac = new Eltetatmoepreuvefac();
                ...
                if (testsicreer) {
                    JOptionPane.showMessageDialog(this, "Etats de vacation pratique d'épreuves facultatives créés avec succès pour ce groupe d'examens !");
                }
            }
        } else {
        ...
        examensSelected.clear();//on vide
        souscentreEltvacpratepreuvefacMap.clear();
    ...
    private void jButtonMettreAjourEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMettreAjourEtatsActionPerformed
        ...
        Map<Souscentre, ArrayList<Eltetatmoepreuvefac>> souscentreEltetatmoepreuvefacMap = new HashMap<>();//contient les sous-centres chacun avec le tableau de ses Eltetatmoepreuvefac
        ArrayList<Souscentre> souscentresAyantDesVacEpreuvefacList = new ArrayList<>();//liste des sous-centres ayant enregistré des candidats aux épreuves facultatives
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment modifier les états de vacation pratique d'épreuves facultatives pour ce groupe d'examens ?", "confirmation de modification", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                ...
                caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
                if (caisses.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Erreur, aucun état de vacation pratique d'épreuves facultatives n'existe pour ce groupe d'examens !");
                } else {
                    ...
                    if (testsimodifier) {
                        JOptionPane.showMessageDialog(this, "Etats de vacation pratique d'épreuves facultatives mis à jour avec succès pour ce groupe d'examens !");
                    }
                }
            } else {
    ...
    private void jButtonSupprimerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEtatsActionPerformed
        infoSaisies();
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment supprimer les états de vacation pratique d'épreuves facultatives pour ce groupe d'examens ?", "confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                anneeSelected = Integer.parseInt(anneeString);
                Rubriquetat rubetat = metier.findRubriquetatByDesignation("VACATION PRATIQUE D'EPREUVES FACULTATIVES");
                ...
                if (caisses.isEmpty()) {
                    ...
                    if (testsisupprimer) {
                        JOptionPane.showMessageDialog(this, "Etats de vacation pratique d'épreuves facultatives supprimés avec succès pour ce groupe d'examens !");
                    }
                }
            }
        }
    ...
    private void jButtonCreerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEffectifActionPerformed
        infoSaisies();
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomSouscentreSelected.equals("---") || sigleEpreuvefacSelected.equals("---") || nbexaminString.equals("") || nbvacString.equals("")) {
            JOptionPane.showMessageDialog(this, "Recommencez svp. Vous devez choisir un groupe d'examens, une session, un sous-centre, une épreuve et donner les nombres d'examinateurs et de vacations !");
        } else {
            validerNbexamin(nbexaminString);
            validerNbvac(nbvacString);
            if (!continuerNbexamin || nbexaminSaisi == 0 || !continuerNbvac || nbvacSaisi == 0) {
                JOptionPane.showMessageDialog(this, "Recommencez svp. Au moins un des deux nombres fournis est incorrect !");
            } else {
                Groupe groupe = metier.findGroupeD1NiveauEtD1Type(niveauSelected, typeSelected);
                anneeSelected = Integer.parseInt(anneeString);
                for (Session s : sessions) {
                ...
                try {
                    metier.creerEltvacpratepreuvefac(new Eltvacpratepreuvefac(souscentreSelected, sessionSelected, groupe, epreuvefacSelected, nbexaminSaisi, nbvacSaisi));
                    JOptionPane.showMessageDialog(this, "Nombres d'examinateurs et de vacations enregistré avec succès !");
                } catch (ObcbudgetException ex) {
                    JOptionPane.showMessageDialog(this, "Impossible de d'enregistrer les nombres d'examinateurs et de vacations dans le sous-centre [" + nomSouscentreSelected + "]" + "\n raison:" + ex.getMessage());
                }
            }
        }
    ...
    private void jButtonSupprimerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEffectifActionPerformed
        ...
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomSouscentreSelected.equals("---") || sigleEpreuvefacSelected.equals("---")) {
            ...
            int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment supprimer les nombres d'examinateurs et de vacations de l'épreueve facultative " + sigleEpreuvefacSelected + " du sous-centre [" + nomSouscentreSelected + "] ?", "confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (result == JOptionPane.YES_OPTION) {
                anneeSelected = Integer.parseInt(anneeString);
                try {
                    Eltvacpratepreuvefac eltvacpratepreuvefac = metier.findEltvacpratepreuvefacD1EpreuvefacD1SouscentreD1GroupedexamensD1Session(nomSouscentreSelected, anneeSelected, niveauSelected, typeSelected, sigleEpreuvefacSelected);
                    metier.supprimerEltvacpratepreuvefac(eltvacpratepreuvefac);
                    JOptionPane.showMessageDialog(this, "Nombres d'examinateurs et de vacations  supprimés avec succès !");
                } catch (ObcbudgetException ex) {
                    JOptionPane.showMessageDialog(this, "Impossible de supprimer les nombres d'examinateurs et de vacations de l'épreuve facultative " + sigleEpreuvefacSelected + " du sous-centre [" + nomSouscentreSelected + "] \n raison:" + ex.getMessage());
                }
            }
        }
            ...
            if (!eltvacpratepreuvefacs.isEmpty()) {
                try {
                    ...
                    for (Region region : regions) {
                        int i = 1;
                        for (Eltvacpratepreuvefac eltvacpratepreuvefac : eltvacpratepreuvefacs) {
                            if (eltvacpratepreuvefac.getSouscentre().getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg().equals(region.getNomreg())) {
                                Map<String, Object> row = new HashMap<>();
                                row.put("session", anneeSelected);
                                row.put("examen", groupedexamensEnstring);
                                row.put("region", region.getNomreg());
                                row.put("num", i++);
                                row.put("souscentre", eltvacpratepreuvefac.getSouscentre().getNomsouscent());
                                row.put("epreuvefac", eltvacpratepreuvefac.getEpreuve().getSigle());
                                row.put("nbexamin", eltvacpratepreuvefac.getNbexamin());
                                row.put("nbvac", eltvacpratepreuvefac.getNbvac());
                                datasource.add(row);
                            }
                        }
                    }
                    JRDataSource jRDataSource = new JRBeanCollectionDataSource(datasource);
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatListeEltvacpratepreuvefacReport.jrxml");
                    JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, jRDataSource);
                    JasperViewer jasperViewer = new JasperViewer(jasperPrint, false);//false empêche jasperviewer de fermer l'appli lorsqu'on le ferme
                    jasperViewer.setVisible(true);
                } catch (JRException e) {
                ...
                JOptionPane.showMessageDialog(this, "Aucun nombre de vacations ou d'examinateurs trouvé dans la base de données !");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueEtatVacationPratiqueEpreuvesFac.class
    ...
    private javax.swing.JTextField jTextFieldNbexamin;
    ...
    private int total = 0, effectif = 0, nbexamin = 0, nbvac = 0, nbtotalvac = 0, coutvac = 0, txcopie = 100, txvac = 1500, coutcopies = 0, nbcopies = 0;
    private boolean continuerNbexamin = false;
    private boolean continuerNbvac = false;
    private int nbexaminSaisi = 0;
    private int nbvacSaisi = 0;
    private String nbexaminString = "";
    private String nbvacString = "";
    private List<Eltetatmoepreuvefac> eltetatmoepreuvefacs = null;
    private List<Eltvacpratepreuvefac> eltvacpratepreuvefacs = null;
    ...
    private void doMyInit() {
        ...
        eltetatmoepreuvefacs = metier.findAllEltetatmoepreuvefacs();
    ...
    private void infoSaisies() {
        ...
        nbexaminString = jTextFieldNbexamin.getText();
        nbvacString = jTextFieldNbvacation.getText();
    }
    ...
    private void validerNbexamin(String nbreString) {
        try {
            nbexaminSaisi = Integer.parseInt(nbreString);
            continuerNbexamin = true;
    ...
    private void determinerCoutD1eltvacpratepreuvefac(Eltvacpratepreuvefac eltvacpratepreuvefac, Eltetatmoepreuvefac eltetatmoepreuvefac) {
        effectif = eltetatmoepreuvefac.getEffectif();
        nbexamin = eltvacpratepreuvefac.getNbexamin();
        nbvac = eltvacpratepreuvefac.getNbvac();
        nbtotalvac = nbexamin * nbvac;
        coutvac = nbtotalvac * txvac;
        nbcopies = effectif;
        coutcopies = effectif * txcopie;
        total = coutvac + coutcopies;
    }
