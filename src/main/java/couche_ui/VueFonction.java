...
public class VueFonction extends javax.swing.JFrame {
    ...
    private void jButtonCreerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerActionPerformed
        ...
        if(!titreSaisi.equals("")){
            try{
                metier.creerFonction(new Fonction(titreSaisi.toUpperCase()));
                JOptionPane.showMessageDialog(this, " Fonction créée avec succès !"); 
                //videFrame();
                fonctions=metier.findAllFonctions();
                int i=1;
                for(Fonction f:fonctions){
                    model.insertRow(model.getRowCount(),new Object[]{f.getIdfonct(), i++,f.getTitre(),f.getVersion()});
                }
            }catch(ObcbudgetException ex){
                JOptionPane.showMessageDialog(this, "Impossible de créer la fonction de titre ["+titreSaisi+"] \n raison:"+ex.getMessage());
            }
        }
    ...
    private void jButtonRechercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRechercherActionPerformed
        ...
        if(!titreSaisi.equals("") && !titreSaisi.equalsIgnoreCase("toutes")){
            try{
                fonctionsRecherchees=metier.findAllFonctionsLikeTitre(titreSaisi.toUpperCase());
                int i=1;
                for(Fonction f:fonctionsRecherchees){
                    model.insertRow(model.getRowCount(),new Object[]{f.getIdfonct(), i++,f.getTitre(),f.getVersion()});
                } 
            }catch(ObcbudgetException ex){
                    JOptionPane.showMessageDialog(this, "Impossible de trouver des fonctions de titre proche de ["+titreSaisi+"] \n raison:"+ex.getMessage()); 
            } 
        }
        else{
    ...
    private void jButtonModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModifierActionPerformed
        infoSaisies(); 
        int result = JOptionPane.showConfirmDialog(this,"Voulez-vous vraiment modifier cette fonction?", "confirmation de modification",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
        if(result == JOptionPane.YES_OPTION){
            if(!titreSaisi.equals("")){
                fonctionCliked=metier.findFonctionById(idFonctionCliked);

                fonctionCliked.setTitre(titreSaisi.toUpperCase());
                try{
                    metier.modifierFonction(fonctionCliked);
                    JOptionPane.showMessageDialog(this, " Fonction modifiée avec succès !");
                    //videFrame();
                    fonctions=metier.findAllFonctions();
                    int i=1;
                    for(Fonction f:fonctions){
                        ...
                        JOptionPane.showMessageDialog(this, "Impossible de modifier la fonction de titre proche de ["+titreSaisi+"] \n raison:"+ex.getMessage()); 
                    }                                   
            }
    ...
    private void jButtonSupprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerActionPerformed
        infoSaisies();
        int result = JOptionPane.showConfirmDialog(this,"Voulez-vous vraiment supprimer cette fonction?", "confirmation de suppression",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
        if(result == JOptionPane.YES_OPTION){
            if(!titreSaisi.equals("")){
                try{
                    metier.supprimerFonction(metier.findFonctionById(idFonctionCliked));
                    JOptionPane.showMessageDialog(this, " Fonction supprimée avec succès !"); 
                    //videFrame();
                    fonctions=metier.findAllFonctions();
                    int i=1;
                    for(Fonction f:fonctions){
                    ...
                    JOptionPane.showMessageDialog(this, "Impossible de supprimer la fonction de titre proche de ["+titreSaisi+"] \n raison:"+ex.getMessage()); 
                }                
            }
            else JOptionPane.showMessageDialog(this, " Le champ titre est obligatoire !"); 
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        idFonctionCliked=(int) model.getValueAt(ligne,0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueFonction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private List<Fonction> fonctionsRecherchees=null;
    private List<Fonction> fonctions=null;
    private int idFonctionCliked=0;
    private Fonction fonctionCliked=null;
