 ...
 */
public class VueEtatConvoyage1SouscentresAdditifBACstt extends javax.swing.JFrame {

    /**
     * Creates new form VueEtatConvoyage1
     */
    public VueEtatConvoyage1SouscentresAdditifBACstt() {
        initComponents();
        doMyInit();
    }
    ...
    private void jButtonVisualiserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVisualiserActionPerformed
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            Rubriquetat rubetat = metier.findRubriquetatByDesignation("CONVOYAGE 1 SOUS-CENTRE");
            ...
            if (!continuer) {
                            ...
                            for (Centrebilletage centrebilletage : centrebilletageSouscentresMap.keySet()) {
                                if (region.getNomreg().equals(centrebilletage.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg())) {
                                    ...
                                    for (int i = 0; i < souscentresList.size(); i++) {
                                        ...
                                        if (souscentreEffectifMap.containsKey(souscentre) && !testSiCentreDeRegroupement(souscentre)) {
                                            ArrayList<Character> phasesList = souscentrePhasesMap.get(souscentre);
                                            phasesEnchaine = "";
                                            if (!phasesList.isEmpty()) {
                                                for (char c : phasesList) {
                                                    if(c!='T') phasesEnchaine += c;
                                                }
                                            }
                ...
                if (typeSelected.equals("IND") || typeSelected.equals("IND PROF")) {
                    try {
                        ...
                        JRDataSource jRDataSource = new JRBeanCollectionDataSource(datasource);
                        JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatConvoyage1ESTISouscentresReport.jrxml");
                        JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, jRDataSource);
                        JasperViewer jasperViewer = new JasperViewer(jasperPrint, false);//false empêche jasperviewer de fermer l'appli lorsqu'on le ferme
                        jasperViewer.setVisible(true);
                    } catch (JRException e) {
                ...
                if (typeSelected.equals("STT") || typeSelected.equals("STT PROF")) {
                    try {
                                ...
                                if (region.getNomreg().equals(centrebilletage.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg())) {
                                    ...
                                    for (int i = 0; i < souscentresList.size(); i++) {
                                        ...
                                        if (souscentreEffectifMap.containsKey(souscentre)) {
                                            ...
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE BALEVENG")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            ...
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE PENKA-MICHEL")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE SANTCHOU")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCEE TECHNIQUE DE FOUMBAN")){
                                                percuCM=7000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE FOUMBOT")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE KOUTABA")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCEE TECHNIQUE DE BAFOUSSAM")){
                                                percuCM=9000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE BAHAM")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE BAMEKA")){
                                                percuCM=7000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE BAMENDJO")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE BANDJOUN")){
                                                percuCM=6000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE BATCHAM")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECHNIQUE DE BAYANGAM")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCEE TECHNIQUE DE MBOUDA")){
                                                percuCM=9000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCEE TECHNIQUE DE BANENGO")){
                                                percuCM=15000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCEE TECHNIQUE DE BANGANGTE")){
                                                percuCM=7000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCEE TECHNIQUE DE BAFANG")){
                                                percuCM=9000;
                                                percuChefsec=0;
                                            }
                                            if(souscentre.getNomsouscent().equals("LYCÉE TECNIQUE DE KEKEM")){
                                                percuCM=5000;
                                                percuChefsec=0;
                                            }
                                            ...
                                            row.put("indemChefsec", indemchefsec);
                                            int totalCMArrondi = (int) Math.ceil((double) totalCM / (double) 1000) * 1000;
                                            int percuCMArrondi = (int) Math.ceil((double) percuCM / (double) 1000) * 1000;
                                            if(totalCM>percuCM) resteCM=totalCM-percuCM;
                                            int resteCMArrondi = (int) Math.ceil((double) resteCM / (double) 1000) * 1000;
                                            row.put("totalCM", totalCMArrondi);
                                            row.put("percuCM", percuCMArrondi);
                                            row.put("resteCM", resteCMArrondi);
                                            int totalChefsecArrondi = (int) Math.ceil((double) totalChefsec / (double) 1000) * 1000;
                                            int percuChefsecArrondi = (int) Math.ceil((double) percuChefsec / (double) 1000) * 1000;
                                            if(totalChefsec>percuChefsec) resteChefsec=totalChefsec-percuChefsec;
                                            int resteChefsecArrondi = (int) Math.ceil((double) resteChefsec / (double) 1000) * 1000;
                                            row.put("totalChefsec", totalChefsecArrondi);
                                            row.put("percuChefsec", percuChefsecArrondi);
                                            row.put("resteChefsec", resteChefsecArrondi);
                                            row.put("baspage", "OBC/AR/"+centrebilletage.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg());
                                            totalMontant += resteCMArrondi + resteChefsecArrondi;//jasperreport prendra la dernière valeur de totalMontant
                                            row.put("totalMontantEnLettres", FrenchNumberToWords.convert(totalMontant).toUpperCase());
                                            datasource.add(row);
                                        }
                                    }
                        ...
                        JRDataSource jRDataSource = new JRBeanCollectionDataSource(datasource);
                        JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatConvoyage1SouscentresBACsttAdditifReport.jrxml");
                        JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, jRDataSource);
                        JasperViewer jasperViewer = new JasperViewer(jasperPrint, false);//false empêche jasperviewer de fermer l'appli lorsqu'on le ferme
                        jasperViewer.setVisible(true);
                    } catch (JRException e) {
                    ...
                    try {
                        for (Souscentre souscentre : souscentreEffectifMap.keySet()) {
                            if (!testSiCentreDeRegroupement(souscentre)) {
                                ...
                                int totalACMArrondi = (int) Math.ceil((double) totalACM / (double) 1000) * 1000;
                                int totalChefsecArrondi = (int) Math.ceil((double) totalChefsec / (double) 1000) * 1000;
                                int net = totalCMArrondi + totalACMArrondi + totalChefsecArrondi;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueEtatConvoyage1SouscentresAdditifBACstt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VueEtatConvoyage1SouscentresAdditifBACstt().setVisible(true);
            }
        });
    }
