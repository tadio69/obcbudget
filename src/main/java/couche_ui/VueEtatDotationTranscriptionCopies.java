...
public class VueEtatDotationTranscriptionCopies extends javax.swing.JFrame {

    public VueEtatDotationTranscriptionCopies() {
        initComponents();
        doMyInit();
    }
    ...
    private void initComponents() {
        ...
        jLabelNbmatscient = new javax.swing.JLabel();
        jLabelNbcandlitter = new javax.swing.JLabel();
        jLabelNbcandscient = new javax.swing.JLabel();
        jTextFieldNbmatscient = new javax.swing.JTextField();
        jTextFieldNbcandlitter = new javax.swing.JTextField();
        jTextFieldNbcandscient = new javax.swing.JTextField();
        jLabelNbmatlitter = new javax.swing.JLabel();
        jTextFieldNbmatlitter = new javax.swing.JTextField();
        ...
        jLabel1.setText("ETAT DOTATION POUR TRANSCRIPTION DES COPIES");
        ...
        jLabelNbmatscient.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabelNbmatscient.setText("Nbre matières scientifiques:");

        jLabelNbcandlitter.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabelNbcandlitter.setText("Nbre cand. littéraires :");

        jLabelNbcandscient.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabelNbcandscient.setText("Nbre cand. scient :");

        jTextFieldNbmatscient.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N

        jTextFieldNbcandlitter.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N

        jTextFieldNbcandscient.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N

        jLabelNbmatlitter.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabelNbmatlitter.setText("Nbre matières littéraires:");

        jTextFieldNbmatlitter.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        jPanelExaminateursLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelExaminateursLayout.createSequentialGroup()
                .addGroup(jPanelExaminateursLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelExaminateursLayout.createSequentialGroup()
                        .addGap(28, 28, 28)
                        .addComponent(jLabelNbmatlitter)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldNbmatlitter, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(52, 52, 52)
                        .addComponent(jLabelNbmatscient)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldNbmatscient, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(48, 48, 48)
                        .addComponent(jLabelNbcandlitter)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldNbcandlitter, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(47, 47, 47)
                        .addComponent(jLabelNbcandscient)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldNbcandscient, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanelExaminateursLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelExaminateursLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanelExaminateursLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelNbmatscient, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelNbcandlitter, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelNbcandscient, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldNbmatscient, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldNbcandlitter, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldNbcandscient, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelNbmatlitter, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldNbmatlitter, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanelExaminateursLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButtonVisualiserEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVisualiserEtatsActionPerformed
        ...
        Map<Souscentre, ArrayList<Elttranscriptcopie>> souscentreElttranscriptcopiesMap = new HashMap<>();//contient chaque sous-centre avec la liste de ses Elttranscriptcopie
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            Rubriquetat rubetat = metier.findRubriquetatByDesignation("VACATION TRANSCRIPTION DES COPIES (DEFICIENT VISUEL)");
            ...
            if (!continuer) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de vacation transcription des copies (déficient visuel) n'ont pas encore été créés pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                ...
                membres = metier.findAllIntervenantsD1GroupeDexamensD1SessionD1ActiviteEt1Qualite(anneeSelected, niveauSelected, typeSelected, phase, "MEMBRE DU JURY DE TRANSCRIPTION DES COPIES");
                tousElttranscriptcopies = metier.findAllElttranscriptcopieD1GroupedexamensD1Session(anneeSelected, niveauSelected, typeSelected);

                if (!membres.isEmpty()) {
                    for (Intervenant mbre : membres) {
                        if (!souscentresAyantDesTranscripteursList.contains(mbre.getSouscentre())) {
                            souscentresAyantDesTranscripteursList.add(mbre.getSouscentre());
                        }
                    }
                    for (Souscentre souscentre : souscentresAyantDesTranscripteursList) {
                        ArrayList<Elttranscriptcopie> elttranscriptcopiesList = new ArrayList<>();
                        for (Elttranscriptcopie elttranscript : tousElttranscriptcopies) {
                            if (elttranscript.getSouscentre().getNomsouscent().equals(souscentre.getNomsouscent())) {
                                elttranscriptcopiesList.add(elttranscript);
                            }
                        }
                        souscentreElttranscriptcopiesMap.put(souscentre, elttranscriptcopiesList);
                    }
                }
                ...
                try {
                            ...
                            if (region.getNomreg().equals(centrebilletage.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg())) {
                                ...
                                for (int i = 0; i < souscentresList.size(); i++) {
                                    ...
                                    if (souscentresAyantDesTranscripteursList.contains(souscentre)) {
                                        for (Elttranscriptcopie elttranscript : souscentreElttranscriptcopiesMap.get(souscentre)) {                                            
                                            String pers = elttranscript.getIntervenant().getPersonnel().getNompers() + " " + elttranscript.getIntervenant().getPersonnel().getPrenom();                                            
                                            String provenance = elttranscript.getIntervenant().getPersonnel().getStructure();                                            
                                            String serie = "";
                                            int nbmat = 0;
                                            int nbcand = 0;
                                            int nbcopies = 0;
                                            ...
                                            int k = 0;
                                            while (k < 2) {
                                                if (k == 0) {//ligne littéraire
                                                    serie = "Lttéraire";
                                                    nbmat = elttranscript.getNbmatlitter();
                                                    nbcand = elttranscript.getNbcandlitter();
                                                    nbcopies = nbmat * nbcand;
                                                    coutcopie = nbcopies * 500;
                                                }
                                                if (k == 1) {//ligne scientifique
                                                    serie = "Scientifique";
                                                    nbmat = elttranscript.getNbmatscient();
                                                    nbcand = elttranscript.getNbcandscient();
                                                    nbcopies = nbmat * nbcand;
                                                    coutcopie = nbcopies * 1000;
                                                }
                                                ...
                                                row.put("nbmat", nbmat);
                                                row.put("nbcand", nbcand);
                                                row.put("nbcopies", nbcopies);
                                                row.put("coutcopie", coutcopie);
                                                row.put("total", coutcopie);
                                                row.put("baspage", "OBC/AR/"+centrebilletage.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg());
                                                totalMontant += coutcopie;//jasperreport prendra la dernière valeur de total
                    ...
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatVacationTranscriptionCopieReport.jrxml");
    ...
    private void jButtonCreerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEtatsActionPerformed
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
            if (!caisses.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de vacation transcription des copies (déficient visuel) existent déjà pour ce groupe d'examens !");
            } else {
                for (Session s : sessions) {
                    if (s.getAnnee() == anneeSelected) {
                        sessionSelected = s;
                ...
                try {
                    for (Souscentre souscentre : souscentresAyantDesTranscripteursList) {
                        int cout = 0;
                        for (Elttranscriptcopie elttranscript : souscentreElttranscriptcopiesMap.get(souscentre)) {
                            cout += elttranscript.getNbmatlitter() * elttranscript.getNbcandlitter() * 500 + elttranscript.getNbmatscient() * elttranscript.getNbcandscient() * 1000;
                        }
                ...
                if (testSicreer) {
                    JOptionPane.showMessageDialog(this, "Etats de vacation transcription des copies (déficient visuel) créés avec succès pour ce groupe d'examens !");
                }
            }//fin else caisses
    ...
    private void jButtonMettreAjourEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMettreAjourEtatsActionPerformed
        ...
        ArrayList<Souscentre> souscentresAyantDesTranscripteursList = new ArrayList<>();//liste des sous-centres ayant des transcripteurs
        Map<Souscentre, ArrayList<Elttranscriptcopie>> souscentreElttranscriptcopiesMap = new HashMap<>();//contient chaque sous-centre avec la liste de ses Elttranscriptcopie
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment modifier les états de vacation transcription des copies (déficient visuel) pour ce groupe d'examens ?", "confirmation de modification", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                ...
                caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
                if (caisses.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Erreur, aucun état de vacation transcription des copies (déficient visuel) n'existe pour ce groupe d'examens !");
                } else {
                    ...
                    if (testSimodifier) {
                        JOptionPane.showMessageDialog(this, "Etats de vacation transcription des copies (déficient visuel) mis à jour avec succès pour ce groupe d'examens !");
                    }
                }//fin else caisses
            }//fin if groupedexamen
            else {
    ...
    private void jButtonSupprimerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEtatsActionPerformed
        infoSaisies();
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment supprimer les états de vacation transcription des copies (déficient visuel) pour ce groupe d'examens ?", "confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                anneeSelected = Integer.parseInt(anneeString);
                Rubriquetat rubetat = metier.findRubriquetatByDesignation("VACATION TRANSCRIPTION DES COPIES (DEFICIENT VISUEL)");
                ...
                if (caisses.isEmpty()) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "Etats de vacation transcription des copies (déficient visuel) supprimés avec succès pour ce groupe d'examens !");
                    } catch (ObcbudgetException e) {
                        JOptionPane.showMessageDialog(this, e.getMessage());
                    }
                }//fin else caisses
    ...
    private void jButtonSupprimerPersonnelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerPersonnelActionPerformed
        ...
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomSouscentreSelected.equals("---") || nomsEtPrenomsSelected.equals("---")) {
            ...
            if (result == JOptionPane.YES_OPTION) {
                ...
                try {
                    Intervenant intervenant = metier.findIntervenantByNomEtPrenomD1GroupeDexamensD1SessionD1SouscentreD1ActiviteEt1Qualite(personnelSelected.getNompers(), personnelSelected.getPrenom(), anneeSelected, nomSouscentreSelected, niveauSelected, typeSelected, phase, "MEMBRE DU JURY DE TRANSCRIPTION DES COPIES");
                    Elttranscriptcopie sonElttranscript = new Elttranscriptcopie();
                    for (Elttranscriptcopie elttranscrip : tousElttranscriptcopies) {
                    ...
                    metier.supprimerElttranscriptcopie(sonElttranscript);
                    metier.supprimerIntervenant(intervenant);
                    JOptionPane.showMessageDialog(this, "Membre de jury de transcription des copies supprimé avec succès !");
                } catch (ObcbudgetException ex) {
                    JOptionPane.showMessageDialog(this, "Impossible de supprimer ce membre de jury de transcription des copies du sous-centre [" + nomSouscentreSelected + "] \n raison:" + ex.getMessage());
                }
            }
        }
    ...
    private void jButtonAnnulerPersonnelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnnulerPersonnelActionPerformed
        ...
        jTextFieldNbmatlitter.setText("");
        jTextFieldNbmatscient.setText("");
        jTextFieldNbcandlitter.setText("");
        jTextFieldNbcandscient.setText("");
    ...
    private void jButtonCreerPersonnelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerPersonnelActionPerformed
        infoSaisies();
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomSouscentreSelected.equals("---") || nbmatlitterString.equals("") || nbmatscientString.equals("") || nbcandlitterString.equals("") || nbcandscientString.equals("")) {
            JOptionPane.showMessageDialog(this, "Recommencez svp. Vous devez choisir un groupe d'examens, une session, un sous-centre, un personnel et les 4 paramètres !");
        } else {
            Groupe groupe = metier.findGroupeD1NiveauEtD1Type(niveauSelected, typeSelected);
            anneeSelected = Integer.parseInt(anneeString);
            ...
            validerNbmatlitter(nbmatlitterString);
            validerNbmatscient(nbmatscientString);
            validerNbcandlitter(nbcandlitterString);
            validerNbcandscient(nbcandscientString);
            boolean testSicreerIntervenant = false;
            boolean testSicreerElttranscriptcopie = false;
            try {
                //personnelSelected est déterminé au moment du clic sur la jcombox
                Activite activite = metier.findActiviteByNom(phase);
                Qualite qualite = metier.findQualiteByTitre("MEMBRE DU JURY DE TRANSCRIPTION DES COPIES");
                ...
                JOptionPane.showMessageDialog(this, "Impossible de créer le membre du jury de transcription des copies pour le sous-centre [" + nomSouscentreSelected + "] \n raison:" + ex.getMessage());
            }
            if (testSicreerIntervenant) {
                metier.creerElttranscriptcopie(new Elttranscriptcopie(souscentreSelected, groupe, sessionSelected, intervenantCreated, nbmatlitterSaisi, nbmatscientSaisi, nbcandlitterSaisi, nbcandscientSaisi));
                testSicreerElttranscriptcopie = true;
            }
            if (testSicreerElttranscriptcopie) {
                JOptionPane.showMessageDialog(this, "Membre du jury de transcription des copies et ses paramètres créés avec succès !");
            }
        }
        ...
        if (groupedexamensEnstring.equals("") || anneeString.equals("---")) {
            ...
            if (!membres.isEmpty()) {
                ...
                try {
                        ...
                        for (Souscentre souscentre : souscentresAyantDesTranscripteursList) {
                            if (region.getNomreg().equals(souscentre.getEtablissement().getArrondissement().getDepartement().getRegion().getNomreg())) {
                                ...
                                for (Elttranscriptcopie elttranscript : souscentreElttranscriptcopiesMap.get(souscentre)) {
                                    ...
                                    row.put("num", i++);
                                    row.put("souscentre", souscentre.getNomsouscent());
                                    row.put("pers", elttranscript.getIntervenant().getPersonnel().getNompers() + " " + elttranscript.getIntervenant().getPersonnel().getPrenom());
                                    row.put("nbmatlitter", elttranscript.getNbmatlitter());
                                    row.put("nbmatscient", elttranscript.getNbmatscient());
                                    row.put("nbcandlitter", elttranscript.getNbcandlitter());
                                    row.put("nbcandscient", elttranscript.getNbcandscient());
                                    datasource.add(row);
                                }
                            }
                        }
                    ...
                    JRDataSource jRDataSource = new JRBeanCollectionDataSource(datasource);
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatListeParametresTranscritcopieReport.jrxml");
                    JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, jRDataSource);
                    JasperViewer jasperViewer = new JasperViewer(jasperPrint, false);//false empêche jasperviewer de fermer l'appli lorsqu'on le ferme
                    jasperViewer.setVisible(true);
                } catch (JRException e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueEtatDotationTranscriptionCopies.class
    ...
    private javax.swing.JLabel jLabelNbcandlitter;
    private javax.swing.JLabel jLabelNbcandscient;
    private javax.swing.JLabel jLabelNbmatlitter;
    private javax.swing.JLabel jLabelNbmatscient;
    ...
    private javax.swing.JTextField jTextFieldNbcandlitter;
    private javax.swing.JTextField jTextFieldNbcandscient;
    private javax.swing.JTextField jTextFieldNbmatlitter;
    private javax.swing.JTextField jTextFieldNbmatscient;
    ...
    private String nbmatlitterString = "";
    private String nbmatscientString = "";
    private String nbcandlitterString = "";
    private String nbcandscientString = "";
    private int nbmatlitterSaisi = 0;
    private int nbmatscientSaisi = 0;
    private int nbcandlitterSaisi = 0;
    private int nbcandscientSaisi = 0;
    private boolean continuerNbmatlitter = false;
    private boolean continuerNbmatscient = false;
    private boolean continuerNbcandlitter = false;
    private boolean continuerNbcandscient = false;
    private Elttranscriptcopie elttranscriptcopie = null;
    private List<Elttranscriptcopie> tousElttranscriptcopies = null;
    ...
    private void infoSaisies() {
        ...
        nomsEtPrenomsSelected = (String) jComboBoxNomsEtPrenoms.getSelectedItem();
        nbmatscientString = jTextFieldNbmatscient.getText();
        nbmatlitterString = jTextFieldNbmatlitter.getText();
        nbcandlitterString = jTextFieldNbcandlitter.getText();
        nbcandscientString = jTextFieldNbcandscient.getText();
    }
    ...
    private void validerNbmatlitter(String nbreString) {
        try {
            nbmatlitterSaisi = Integer.parseInt(nbreString);
            continuerNbmatlitter = true;
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Le nombre de matières littéraires doit être fournis et contenir uniquement des chiffres entiers!");
            continuerNbmatlitter = false;
        }
    }

    private void validerNbmatscient(String nbreString) {
        try {
            nbmatscientSaisi = Integer.parseInt(nbreString);
            continuerNbmatscient = true;
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Le nombre de matières scientifiques doit être fournis et contenir uniquement des chiffres entiers!");
            continuerNbmatscient = false;
        }
    }

    private void validerNbcandlitter(String nbreString) {
        try {
            nbcandlitterSaisi = Integer.parseInt(nbreString);
            continuerNbcandlitter = true;
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Le nombre de candidats littéraires doit être fourni et contenir uniquement des chiffres entiers!");
            continuerNbcandlitter = false;
        }
    }

    private void validerNbcandscient(String nbreString) {
        try {
            nbcandscientSaisi = Integer.parseInt(nbreString);
            continuerNbcandscient = true;
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Le nombre de candidats scientifiques doit être fourni et contenir uniquement des chiffres entiers!");
            continuerNbcandscient = false;
        }
    }
}
