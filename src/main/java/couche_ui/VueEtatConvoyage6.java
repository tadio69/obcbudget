...
public class VueEtatConvoyage6 extends javax.swing.JFrame {

    public VueEtatConvoyage6() {
        initComponents();
        doMyInit();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ETAT DE CONVOYAGE 6");
        ...
        jPanelJurys.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Effectifs reçus", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 3, 14), new java.awt.Color(0, 0, 255))); // NOI18N
    ...
    private void jButtonVisualiserEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVisualiserEtatsActionPerformed
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            Rubriquetat rubetat = metier.findRubriquetatByDesignation("INDEMNITE POUR CONVOYAGE 6 ET VENTILATION DES COPIES");
            ...
            if (!poursuivre) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de convoyage 6 n'ont pas encore été créés pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                ...
                tousNblivrets = metier.findAllNblivretsD1GroupedexamensD1Session(anneeSelected, niveauSelected, typeSelected);
                if (!tousNblivrets.isEmpty()) {
                    for (Nblivrets nbliv : tousNblivrets) {
                        centreEffectifMap.put(nbliv.getCentre(), nbliv.getNombre());
                    }
                }
                ...
                try {
                    ...
                    JasperReport jasperReport = JasperCompileManager.compileReport("src\\main\\java\\reports\\etatConvoyage6Report.jrxml");
    ...
    private void jButtonCreerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEtatsActionPerformed
        ...
        if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
            ...
            caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
            if (!caisses.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Erreur, les états de convoyage 6 existent déjà pour ce groupe d'examens !");
            } else {
                String separateur = ", ";
                examensList = groupedexamensEnstring.split(separateur);
                for (int i = 0; i < examensList.length; i++) {
                ...
                if (testsicreer) {
                    JOptionPane.showMessageDialog(this, "Etats de convoyage 6 créés avec succès pour ce groupe d'examens !");
                }
            }
        } else {
    ...
    private void jButtonMettreAjourEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMettreAjourEtatsActionPerformed
        infoSaisies();
        Map<Centre, Integer> centreEffectifMap = new HashMap<>();//contient l'ensemble des centres avec leur effectif
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment modifier les états de convoyage 6 pour ce groupe d'examens ?", "confirmation de modification", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                ...
                caisses = metier.findAllCaissesD1GroupedexamensDans1RubriquetatEt1Session(rubetat.getDesignation(), anneeSelected, niveauSelected, typeSelected);
                if (caisses.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Erreur, aucun état de convoyage 6 n'existe pour ce groupe d'examens !");
                } else {
    ...
    private void jButtonSupprimerEtatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEtatsActionPerformed
        infoSaisies();
        int result = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment supprimer les états de convoyage 6 pour ce groupe d'examens ?", "confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (result == JOptionPane.YES_OPTION) {
            if (!groupedexamensEnstring.equals("") && !anneeString.equals("---")) {
                anneeSelected = Integer.parseInt(anneeString);
                Rubriquetat rubetat = metier.findRubriquetatByDesignation("INDEMNITE POUR CONVOYAGE 6 ET VENTILATION DES COPIES");
                ...
                if (caisses.isEmpty()) {
                    ...
                    if (testsisupprimer) {
                        JOptionPane.showMessageDialog(this, "Etats de convoyage 6 supprimés avec succès pour ce groupe d'examens !");
                    }
                }
            }
        }
    ...
    private void jButtonCreerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreerEffectifActionPerformed
        ...
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomCentredeliberationSelected.equals("---") || effectifString.equals("")) {
            ...
            if (!continuer || effectif == 0) {
                ...
                try {
                    metier.creerNblivrets(new Nblivrets(centredeliberationSelected, groupe, sessionSelected, effectif));
    ...
    private void jButtonSupprimerEffectifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerEffectifActionPerformed
        ...
        if (groupedexamensEnstring.equals("") || anneeString.equals("---") || nomCentredeliberationSelected.equals("---")) {
            ...
            if (result == JOptionPane.YES_OPTION) {
                anneeSelected = Integer.parseInt(anneeString);
                try {
                    Nblivrets nbliv = metier.findNblivretsD1CentredeliberationD1GroupedexamensD1Session(nomCentredeliberationSelected, anneeSelected, niveauSelected, typeSelected);
                    metier.supprimerNblivrets(nbliv);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueEtatConvoyage6.class
    ...
    private List<Nblivrets> tousNblivrets = null;
